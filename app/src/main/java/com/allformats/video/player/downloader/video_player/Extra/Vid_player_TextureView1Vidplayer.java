...
public class Vid_player_TextureView1Vidplayer extends Vid_player_TextreView {
    protected static final String TAG = "JZResizeTextureView";
    public int currentVideoHeight;
    public int currentVideoWidth;

    public Vid_player_TextureView1Vidplayer(Context context) {
        super(context);
    ...
    public Vid_player_TextureView1Vidplayer(Context context, AttributeSet attributeSet) {
