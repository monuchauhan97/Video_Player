...
public class Vid_player_MP3VidplayerAudioConnector extends Vid_player_AudioConnector {
    public static void tryConnectAudio(String str, final OnConnectionCompleteListener onConnectionCompleteListener) {
        new Vid_player_AudioDecipher(str, new Vid_player_AudioDecipher.Callback() {
            ...
            public void onSuccess(List<AudioStream> list) {
                AudioStream findFormat = Vid_player_MP3VidplayerAudioConnector.findFormat(list, 256);
                if (findFormat == null) {
                    findFormat = Vid_player_MP3VidplayerAudioConnector.findFormat(list, 768);
                }
                if (findFormat == null) {
